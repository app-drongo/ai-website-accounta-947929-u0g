...
const DEFAULT_HERO = {
  ...
  title: 'Streamline your business finances with',
  titleHighlight: "Accounta's smart accounting",
  description:
    'Automate bookkeeping, track expenses, and generate financial reports in minutes. Built specifically for small businesses who need professional accounting without the complexity.',
  features: [
  ...
  imageAlt: 'Accounta dashboard showing financial analytics',
  statsLabel1: 'Time Saved',
  statsValue1: '15hrs/month',
