...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    'Join thousands of small businesses who trust Accounta for their accounting needs. Our team is here to help you get started and answer any questions.',
  formTitle: 'Schedule Your Free Demo',
  formDescription:
    "Get a personalized walkthrough of Accounta's features and see how we can streamline your accounting workflow.",
  ...
  messageLabel: 'Tell us about your accounting needs *',
  messagePlaceholder:
    "I'm looking for help with bookkeeping, tax preparation, and financial reporting for my retail business...",
} as const;
